...
pour importer un projet dans python anywhere  voir la video https://www.youtube.com/watch?v=xtnUwvjOThg
1- ouvrir un bash
2- pwd
3- git clone https://github.com/thibaudcottineau/le_nom_du_projet
4- mkvirtualenv --python=/usr/bin/python3.10 venv
5- cd le_nom_du_projet  
6- pip install -r requirements.txt
7- sur la page WEB a virtualenv = venv
8- dans WSGI configuration file:
	project_home = '/home/cotinedev/exercice_3/projet_1'
	os.environ['DJANGO_SETTINGS_MODULE'] = 'mysite.settings'
9- dans le projet settings.py 
	ALLOWED_HOSTS = ['cotinedev.eu.pythonanywhere.com']
10- enlever l'appli DEBUG_TOOLBAR